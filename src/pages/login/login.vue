<template>
  <view class="login-wrapper">
    <navigator open-type="navigateBack" :delta="1" class="back-arrow" :style="{'top': safeAreaInsets?.top + 'px'}"><up-icon name="arrow-left"></up-icon></navigator>
    <view>
    ...
    <template v-if="type==='login'">
      <view class="login-form">
        ...
        <view style="margin-bottom: 30rpx;">
          <uni-easyinput type="password" primaryColor="#558dda;" v-model="loginInfo.password" placeholder="请输入密码"></uni-easyinput>
        </view>
    ...
    <template v-else>
      <view class="login-form">
        ...
        <view style="margin-bottom: 30rpx;">
          <uni-easyinput type="password" primaryColor="#558dda;" v-model="regInfo.password" placeholder="请输入密码"></uni-easyinput>
        </view> <view style="margin-bottom: 30rpx;">
          <uni-easyinput type="password" primaryColor="#558dda;" v-model="regInfo.passwordConfirm" placeholder="请再次输入密码"></uni-easyinput>
        </view>
